...
public class JdbcAccountsRetriever
{
    ...
    {
        String sql = "SELECT DOM_LKEY, DOM_BISDELETED, DOM_SNAME, DOM_BDEFAULTSTORE, DOM_SCONFIGNAME, DOM_XMLDATA " +
    ...
    {
        String sql = "SELECT USR_HKEY, USR_SUID, USR_SFULLNAME, USR_DTETIMESTAMP, USR_UT_LKEY, " +
    ...
    {
        String sql = "SELECT USF_NAME, USF_VALUE FROM TUSERFIELD WHERE USF_USR_HKEY = ?";
